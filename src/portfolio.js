...
const greeting = {
  ...
  resumeLink:
    "https://drive.google.com/file/d/1fySF0u1QNzltA3cTJ22NYGxcqqhJVSY5/view?usp=drivesdk", // Set to empty to hide the button
...
const achievementSection = {
  ...
  achievementsCards: [
    {
      title: "Bronze Medalist at IIIT Una",
      subtitle:
        "Secured 3rd rank in First year and Second year of B.Tech.",
      image: require("./assets/images/iiitLogo.png"),
